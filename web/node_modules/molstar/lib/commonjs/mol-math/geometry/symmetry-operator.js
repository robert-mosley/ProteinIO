...
const mat3_1 = require("../linear-algebra/3d/mat3.js");
const mat4_1 = require("../linear-algebra/3d/mat4.js");
const quat_1 = require("../linear-algebra/3d/quat.js");
...
(function (SymmetryOperator) {
    ...
    function create(name, matrix, info) {
        ...
        if (isIdentity)
            return { name, instanceId, assembly, matrix, inverse: mat4_1.Mat4.identity(), isIdentity: true, hkl: _hkl, spgrOp, ncsId, suffix, key };
        ...
        return { name, instanceId, assembly, matrix, inverse: mat4_1.Mat4.invert((0, mat4_1.Mat4)(), matrix), isIdentity: false, hkl: _hkl, spgrOp, key, ncsId, suffix };
    }
