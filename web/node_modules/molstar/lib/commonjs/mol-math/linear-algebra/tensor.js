...
const mat4_1 = require("./3d/mat4.js");
const mat3_1 = require("./3d/mat3.js");
var Tensor;
(function (Tensor) {
    ...
    function floodfill3(tensor, threshold) {
        ...
        const { dataOffset: o, getCoords } = tensor.space;
        const stack = [];
        const coords = [0, 0, 0]; // reused coordinates array
        const xn1 = xn - 1;
        const yn1 = yn - 1;
        const zn1 = zn - 1;
    ...
    Tensor.createFloodfilled = createFloodfilled;
})(Tensor || (exports.Tensor = Tensor = {}));
