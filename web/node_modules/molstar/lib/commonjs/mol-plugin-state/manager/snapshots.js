...
class PluginStateSnapshotManager extends component_1.StatefulPluginComponent {
    ...
    setSnapshotAnimationFrame(currentAnimationTimeMs, load = false) {
        ...
        if (!entry)
            return;
        const frameIndex = (_a = state_1.PluginState.getStateTransitionFrameIndex(entry.snapshot, currentAnimationTimeMs)) !== null && _a !== void 0 ? _a : 0;
    ...
    constructor(plugin) {
        ...
        this.animationFrameQueue = new single_task_queue_1.SingleTaskQueue();
        this.timeoutHandle = void 0;
        this.next = async () => {
            this.timeoutHandle = void 0;
