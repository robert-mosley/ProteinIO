...
const symbol_1 = require("../../language/symbol.js");
const symbol_table_1 = require("../../language/symbol-table.js");
const type_1 = require("../../language/type.js");
const structure_query_1 = require("../../language/symbol-table/structure-query.js");
const builder_1 = require("../../language/builder.js");
const script_macro_1 = require("./script-macro.js");
...
exports.SymbolTable = [
    ...
    [
        ...
        [
            ...
            Alias(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.core.instanceId, 'atom.instance-id'),
            ...
            Alias(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.core.modelEntryId, 'atom.model-entry-id'),
...
const normalized = (function () {
    ...
    const namedArgs = unique_array_1.UniqueArray.create();
    const constants = unique_array_1.UniqueArray.create();
    for (const s of list) {
        ...
        if (args.kind !== 'dictionary') {
            if (args.type.kind === 'oneof') {
                type_1.Type.oneOfValues(args.type).forEach(v => unique_array_1.UniqueArray.add(constants, v, v));
            }
            continue;
        }
        for (const a of Object.keys(args.map)) {
            if (isNaN(a))
                unique_array_1.UniqueArray.add(namedArgs, a, a);
            const arg = (args.map[a]);
            if (arg.type.kind === 'oneof') {
                type_1.Type.oneOfValues(arg.type).forEach(v => unique_array_1.UniqueArray.add(constants, v, v));
            }
        }
    }
