...
const symbol_table_1 = require("../../language/symbol-table.js");
...
const internal_1 = require("../../../mol-model/structure/query/queries/internal.js");
...
const symbols = [
    ...
    C(symbol_table_1.MolScriptSymbolTable.core.math.cantorPairing, (ctx, v) => (0, hash_functions_1.cantorPairing)(v[0](ctx), v[1](ctx))),
    C(symbol_table_1.MolScriptSymbolTable.core.math.sortedCantorPairing, (ctx, v) => (0, hash_functions_1.sortedCantorPairing)(v[0](ctx), v[1](ctx))),
    C(symbol_table_1.MolScriptSymbolTable.core.math.invertCantorPairing, (ctx, v) => (0, hash_functions_1.invertCantorPairing)([0, 0], v[0](ctx))),
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.core.instanceId, atomProp(structure_1.StructureProperties.unit.instance_id)),
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.core.modelEntryId, atomProp(structure_1.StructureProperties.unit.model_entry_id)),
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.core.atomKey, (ctx, xs) => {
        ...
        return (0, hash_functions_1.cantorPairing)(e.unit.id, e.element);
    }),
    // TODO:
    ...
    D(symbol_table_1.MolScriptSymbolTable.structureQuery.atomProperty.macromolecular.residueSourceIndex, atomProp(structure_1.StructureProperties.residue.residueSourceIndex)),
