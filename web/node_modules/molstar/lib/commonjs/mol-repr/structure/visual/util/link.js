...
function createLinkCylinderMesh(ctx, linkBuilder, props, mesh) {
    ...
    const oldBoundingSphere = (mesh === null || mesh === void 0 ? void 0 : mesh.hasBoundingSphere()) ? sphere3d_1.Sphere3D.clone(mesh.boundingSphere) : undefined;
...
function createLinkCylinderImpostors(ctx, linkBuilder, props, cylinders) {
    ...
    const oldBoundingSphere = (cylinders === null || cylinders === void 0 ? void 0 : cylinders.hasBoundingSphere()) ? sphere3d_1.Sphere3D.clone(cylinders.boundingSphere) : undefined;
...
function createLinkLines(ctx, linkBuilder, props, lines) {
    ...
    const oldBoundingSphere = (lines === null || lines === void 0 ? void 0 : lines.hasBoundingSphere()) ? sphere3d_1.Sphere3D.clone(lines.boundingSphere) : undefined;
