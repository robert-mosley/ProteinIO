...
const polymer_1 = require("../polymer.js");
const secondary_structure_1 = require("../../../../../mol-model-props/computed/secondary-structure.js");
const helix_orientation_1 = require("../../../../../mol-model-props/computed/helix-orientation.js");
const segmentation_1 = require("../../../../../mol-data/int/segmentation.js");
...
class AtomicPolymerTraceIterator {
    ...
    constructor(unit, structure, options = {}) {
        ...
        this.residueIt = segmentation_1.Segmentation.transientSegments(this.residueAtomSegments, unit.elements);
