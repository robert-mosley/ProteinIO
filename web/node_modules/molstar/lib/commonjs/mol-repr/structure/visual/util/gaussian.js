...
const cpu_1 = require("../../../../mol-math/geometry/gaussian-density/cpu.js");
exports.GaussianDensityParams = {
    ...
    smoothness: param_definition_1.ParamDefinition.Numeric(1.5, { min: 1, max: 3, step: 0.1 }, { description: 'Smoothness of the gausian surface, lower is smoother.' }),
    floodfill: param_definition_1.ParamDefinition.Select('off', param_definition_1.ParamDefinition.arrayToOptions(['off', 'inside', 'outside']), { description: 'If and how to floodfill the gaussian surface. Note that this disables GPU support.' }),
