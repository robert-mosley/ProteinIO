...
function createElementSphereMesh(ctx, unit, structure, theme, props, mesh) {
    ...
    const oldBoundingSphere = (mesh === null || mesh === void 0 ? void 0 : mesh.hasBoundingSphere()) ? geometry_1.Sphere3D.clone(mesh.boundingSphere) : undefined;
...
function createElementSphereImpostor(ctx, unit, structure, theme, props, spheres) {
    ...
    const oldBoundingSphere = (spheres === null || spheres === void 0 ? void 0 : spheres.hasBoundingSphere()) ? geometry_1.Sphere3D.clone(spheres.boundingSphere) : undefined;
    const { elements, conformation: c } = unit;
    const elementCount = elements.length;
...
function getElementLoci(pickingId, structureGroup, id) {
    ...
    if (id === objectId) {
        ...
        const indices = groupId === picking_1.PickingId.Null
            ? int_1.OrderedSet.ofRange(0, unit.elements.length)
            : int_1.OrderedSet.ofSingleton(groupId);
