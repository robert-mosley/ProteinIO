...
const gaussian_surface_mesh_1 = require("../visual/gaussian-surface-mesh.js");
const units_representation_1 = require("../units-representation.js");
const gaussian_surface_wireframe_1 = require("../visual/gaussian-surface-wireframe.js");
...
const GaussianSurfaceVisuals = {
    ...
    'structure-gaussian-surface-wireframe': (ctx, getParams) => (0, representation_1.ComplexRepresentation)('Structure-Gaussian surface wireframe', ctx, getParams, gaussian_surface_wireframe_1.StructureGaussianWireframeVisual),
};
