...
const molecular_surface_mesh_1 = require("../visual/molecular-surface-mesh.js");
...
const molecular_surface_wireframe_1 = require("../visual/molecular-surface-wireframe.js");
...
const MolecularSurfaceVisuals = {
    ...
    'structure-molecular-surface-wireframe': (ctx, getParams) => (0, representation_1.ComplexRepresentation)('Structure Molecular surface mesh', ctx, getParams, molecular_surface_wireframe_1.StructureMolecularSurfaceWireframeVisual),
};
