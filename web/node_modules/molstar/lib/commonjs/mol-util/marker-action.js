...
exports.MarkerActions = exports.MarkerAction = void 0;
...
const type_helpers_1 = require("./type-helpers.js");
var MarkerAction;
...
function applyMarkerAction(array, set, action) {
    ...
    if (interval_1.Interval.is(set)) {
        const start = interval_1.Interval.start(set);
        const end = interval_1.Interval.end(set);
