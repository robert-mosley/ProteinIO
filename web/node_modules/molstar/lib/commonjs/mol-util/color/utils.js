...
exports.getColorGradientBanded = getColorGradientBanded;
exports.getColorGradient = getColorGradient;
exports.parseColorList = parseColorList;
...
function getColorGradientBanded(colors) {
...
function getColorGradient(colors) {
    if (colors.length === 0)
        return 'linear-gradient(to right, #000 0%, #000 100%)';
    const hasOffsets = colors.every(c => Array.isArray(c));
    let styles;
...
function parseColorList(input, separator = /,/) {
    const ret = [];
