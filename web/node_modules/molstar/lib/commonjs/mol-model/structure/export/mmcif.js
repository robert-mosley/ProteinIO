...
const atom_site_1 = require("./categories/atom_site.js");
var CifCategory = cif_1.CifWriter.Category;
const secondary_structure_1 = require("./categories/secondary-structure.js");
const misc_1 = require("./categories/misc.js");
const utils_1 = require("./categories/utils.js");
const sequence_1 = require("./categories/sequence.js");
const custom_property_1 = require("../../custom-property.js");
const atom_site_operator_mapping_1 = require("./categories/atom_site_operator_mapping.js");
const mmcif_1 = require("../../../mol-model-formats/structure/mmcif.js");
const molstar_bond_site_1 = require("./categories/molstar_bond_site.js");
...
function encode_mmCIF_categories_default(encoder, ctx, params) {
    ...
    for (const cat of Categories({
        ...
        if (includedCategories.has(cat.name))
            continue;
