...
const ColumnHelpers = tslib_1.__importStar(require("./column-helpers.js"));
const tensor_1 = require("../../mol-math/linear-algebra/tensor.js");
const number_parser_1 = require("../../mol-io/reader/common/text/number-parser.js");
var Column;
(function (Column) {
    let Schema;
    (function (Schema) {
        ...
        function Vector(dim, baseType = Schema.float) { return Tensor(tensor_1.Tensor.Vector(dim, baseType['@type'] === 'int' ? Int32Array : Float64Array), baseType); }
        Schema.Vector = Vector;
        function Matrix(rows, cols, baseType = Schema.float) { return Tensor(tensor_1.Tensor.ColumnMajorMatrix(rows, cols, baseType['@type'] === 'int' ? Int32Array : Float64Array), baseType); }
