...
(function (Table) {
    ...
    function formatToString(table) {
        ...
        let headerLength = 1;
        string_builder_1.StringBuilder.write(sb, '|');
        for (let i = 0; i < cols.length; i++) {
            string_builder_1.StringBuilder.write(sb, cols[i]);
            string_builder_1.StringBuilder.write(sb, '|');
            headerLength += cols[i].length + 1;
        }
        string_builder_1.StringBuilder.newline(sb);
        string_builder_1.StringBuilder.write(sb, new Array(headerLength + 1).join('-'));
        string_builder_1.StringBuilder.newline(sb);
        for (let r = 0; r < _rowCount; r++) {
            ...
            for (let i = 0; i < cols.length; i++) {
                ...
                if (c.valueKind(r) === column_1.Column.ValueKinds.Present) {
                    string_builder_1.StringBuilder.write(sb, c.value(r));
                    string_builder_1.StringBuilder.write(sb, '|');
                }
                else {
                    string_builder_1.StringBuilder.write(sb, '.|');
        ...
        return string_builder_1.StringBuilder.getString(sb);
    }
