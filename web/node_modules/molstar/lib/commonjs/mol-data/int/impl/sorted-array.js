...
const array_1 = require("../../util/array.js");
const hash_functions_1 = require("../../util/hash-functions.js");
const sort_1 = require("../../util/sort.js");
const interval_1 = require("../interval.js");
exports.Empty = [];
function ofSingleton(v) { return [v]; }
function ofSortedArray(xs) { return xs; }
function ofUnsortedArray(xs) { (0, sort_1.sortArray)(xs); return xs; }
...
function hashCode(xs) {
    ...
    if (!s)
        return 0;
    if (s > 2)
        return (0, hash_functions_1.hash4)(s, xs[0], xs[s - 1], xs[s >> 1]);
    return (0, hash_functions_1.hash3)(s, xs[0], xs[s - 1]);
}
...
function indicesOf(a, b) {
    if (areEqual(a, b))
        return ofSortedArray((0, array_1.createRangeArray)(0, a.length - 1));
    const { startI: sI, startJ: sJ, endI, endJ } = getSuitableIntersectionRange(a, b);
    let i = sI, j = sJ;
    let commonCount = 0;
    while (i < endI && j < endJ) {
