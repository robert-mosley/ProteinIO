...
const mvs_tree_primitives_1 = require("./mvs-tree-primitives.js");
const mvs_tree_representations_1 = require("./mvs-tree-representations.js");
const param_types_1 = require("./param-types.js");
const SelectorT = (0, field_schema_1.union)(param_types_1.ComponentSelectorT, param_types_1.ComponentExpressionT, (0, field_schema_1.list)(param_types_1.ComponentExpressionT));
...
const TransformParams = (0, params_schema_1.SimpleParamsSchema)({
    ...
    rotation_center: (0, field_schema_1.OptionalField)((0, field_schema_1.nullable)((0, field_schema_1.union)(param_types_1.Vector3, (0, field_schema_1.literal)('centroid'))), null, 'Point to rotate the object around. Can be either a 3D vector or dynamically computed object centroid.'),
    ...
    matrix: (0, field_schema_1.OptionalField)((0, field_schema_1.nullable)(param_types_1.Matrix), null, 'Transform matrix (4x4 matrix flattened in column major format (j*4+i indexing), this is equivalent to Fortran-order in numpy). This matrix will multiply the structure coordinates from the left. Takes precedence over `rotation` and `translation`.'),
});
    ...
    nodes: {
        ...
        structure: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                coordinates_ref: (0, field_schema_1.OptionalField)((0, field_schema_1.nullable)(field_schema_1.str), null, 'Reference to a specific set of coordinates.')
            }),
        },
        ...
        component: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                selector: (0, field_schema_1.RequiredField)(SelectorT, 'Defines what part of the parent structure should be included in this component.'),
            }),
        },
        ...
        color: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                selector: (0, field_schema_1.OptionalField)(SelectorT, 'all', 'Defines to what part of the representation this color should be applied.'),
            }),
        },
        ...
        color_from_uri: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                palette: (0, field_schema_1.OptionalField)((0, field_schema_1.nullable)(param_types_1.Palette), null, 'Customize mapping of annotation values to colors.'),
                /** Defines to what part of the representation this coloring should be applied. */
                selector: (0, field_schema_1.OptionalField)(SelectorT, 'all', 'Defines to what part of the representation this coloring should be applied.'),
            }),
        },
        ...
        clip: {
            ...
            params: mvs_tree_representations_1.MVSClipParams,
        },
        ...
        label_from_uri: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                text_format: (0, field_schema_1.OptionalField)(field_schema_1.str, '{}', 'Formatting template for the label text. Supports simplified f-string syntax.'),
        ...
        tooltip_from_uri: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                text_format: (0, field_schema_1.OptionalField)(field_schema_1.str, '{}', 'Formatting template for the tooltip text. Supports simplified f-string syntax.'),
            }),
        },
        ...
        camera: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                near: (0, field_schema_1.OptionalField)((0, field_schema_1.nullable)(field_schema_1.float), null, 'Near clipping plane distance from the position.'),
            }),
        },
        ...
        canvas: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                background_color: (0, field_schema_1.OptionalField)(param_types_1.ColorT, 'white', 'Color of the canvas background. Can be either an X11 color name (e.g. `"red"`) or a hexadecimal code (e.g. `"#FF0011"`). Defaults to white.'),
            }),
        },
        primitives: {
            ...
            params: (0, params_schema_1.SimpleParamsSchema)({
                ...
                label_show_tether: (0, field_schema_1.OptionalField)(field_schema_1.bool, false, 'Whether to show a tether line between the label and the target. Defaults to false.'),
                /** Length of the tether line between the label and the target. Defaults to 1 (Angstrom). */
                label_tether_length: (0, field_schema_1.OptionalField)(field_schema_1.float, 1, 'Length of the tether line between the label and the target. Defaults to 1 (Angstrom).'),
                /** How to attach the label to the target. Defaults to "middle-center". */
                label_attachment: (0, field_schema_1.OptionalField)(param_types_1.LabelAttachments, 'middle-center', 'How to attach the label to the target. Defaults to "middle-center".'),
                /** Background color of the label. Defaults to none/transparent. */
                label_background_color: (0, field_schema_1.OptionalField)((0, field_schema_1.nullable)(param_types_1.ColorT), null, 'Background color of the label. Defaults to none/transparent.'),
                /** Load snapshot with the provided key when interacting with this primitives group. */
                snapshot_key: (0, field_schema_1.OptionalField)((0, field_schema_1.nullable)(field_schema_1.str), null, 'Load snapshot with the provided key when interacting with this primitives group.'),
