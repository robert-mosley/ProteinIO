...
interface MVSComponentCache {
    source?: Structure;
}
/** Create a substructure PSO based on `MVSAnnotationStructureComponentProps` */
export declare function createMVSAnnotationStructureComponent(structure: Structure, params: MVSAnnotationStructureComponentProps, cache: MVSComponentCache): StateObject<any, any> | SO.Molecule.Structure;
