...
exports.MVSAnnotationStructureComponent = (0, exports.MVSTransform)({
    ...
    apply({ a, params, cache }) {
        return createMVSAnnotationStructureComponent(a.data, params, cache);
    },
    update: ({ a, b, oldParams, newParams, cache }) => {
        return updateMVSAnnotationStructureComponent(a.data, b, oldParams, newParams, cache);
    },
    dispose({ b }) {
...
function createMVSAnnotationStructureComponent(structure, params, cache) {
...
function updateMVSAnnotationStructureComponent(a, b, oldParams, newParams, cache) {
    const structureChanged = !cache.source || !structure_1.Structure.areEquivalent(a, cache.source);
    cache.source = a;
    if (structureChanged) {
        return mol_state_1.StateTransformer.UpdateResult.Recreate;
    }
    const coreParamsChanged = !(0, mol_util_1.deepEqual)((0, object_1.omitObjectKeys)(newParams, ['label']), (0, object_1.omitObjectKeys)(oldParams, ['label']));
