...
exports.MVSAnnotationTooltipsParams = {
    tooltips: param_definition_1.ParamDefinition.ObjectList({
        ...
        textFormat: param_definition_1.ParamDefinition.Text('{}', { description: 'Formatting template for tooltip text. Supports simplified f-string syntax. May reference multiple annotation fields. If value in any field is not defined, tooltip will not be displayed.' }),
    ...
    label: (loci) => {
        switch (loci.kind) {
            case 'element-loci':
                ...
                const texts = tooltipProps.tooltips.map(p => (0, string_format_1.FormatTemplate)(p.textFormat).format(field => { var _a; return (_a = annotations === null || annotations === void 0 ? void 0 : annotations.getAnnotation(p.annotationId)) === null || _a === void 0 ? void 0 : _a.getValueForLocation(location, field || p.fieldName); }));
