    ...
    if (ctx.structure) {
        ...
        color = (location) => {
            if (structure_1.StructureElement.Location.is(location)) {
                ...
                const unitElementIndex = ordered_set_1.OrderedSet.findPredecessorIndex(units[unitIndex].elements, location.element);
                ...
                const unitElementIndex = ordered_set_1.OrderedSet.findPredecessorIndex(units[unitIndex].elements, location.aUnit.elements[location.aIndex]);
                return palette.color(cummulativeElementCount.get(unitIndex) + unitElementIndex);
            }
            return DefaultColor;
        };
