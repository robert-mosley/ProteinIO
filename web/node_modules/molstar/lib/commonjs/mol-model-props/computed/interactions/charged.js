...
const types_2 = require("../../../mol-model/structure/model/properties/atomic/types.js");
...
const functional_group_1 = require("../chemistry/functional-group.js");
    ...
    while (residueIt.hasNext) {
        ...
        if (PositvelyCharged.includes(compId)) {
            ...
            for (let j = start; j < end; ++j) {
                ...
                else if ((0, functional_group_1.isQuaternaryAmine)(structure, unit, j)) {
                    group = common_1.FeatureGroup.QuaternaryAmine;
                    // special handling for N+: mark the entire functional group
                    builder.startState();
                    addedElements.add(j);
                    builder.pushMember(x[elements[j]], y[elements[j]], z[elements[j]], j);
                    (0, util_1.eachIntraBondedAtom)(unit, j, (_, k) => {
                        addedElements.add(k);
