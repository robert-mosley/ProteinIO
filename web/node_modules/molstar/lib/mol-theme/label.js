 ...
 */
import { Unit, StructureElement, StructureProperties as Props } from '../mol-model/structure.js';
import { Loci } from '../mol-model/loci.js';
import { OrderedSet } from '../mol-data/int/ordered-set.js';
import { capitalize, stripTags } from '../mol-util/string.js';
import { Column } from '../mol-data/db/column.js';
