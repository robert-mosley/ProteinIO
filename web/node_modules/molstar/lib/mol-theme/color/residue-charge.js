...
export function getResidueChargeColorThemeParams(ctx) {
...
export function residueChargeColor(colorMap, residueName) {
    const c = colorMap[residueName];
    return c === undefined ? DefaultResidueChargeColor : c;
}
export function ResidueChargeColorTheme(ctx, props) {
...
export const ResidueChargeColorThemeProvider = {
    name: 'residue-charge',
