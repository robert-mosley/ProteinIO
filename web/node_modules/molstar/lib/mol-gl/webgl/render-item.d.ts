 ...
 */
import { WebGLContext } from './context.js';
import { ShaderCode } from '../shader-code.js';
import { Program } from './program.js';
import { RenderableSchema, RenderableValues } from '../renderable/schema.js';
import { UniformsList } from './uniform.js';
...
export declare function createGraphicsRenderItem(ctx: WebGLContext, drawMode: DrawMode, shaderCode: ShaderCode, schema: RenderableSchema, values: RenderableValues, materialId: number, transparency: Transparency): RenderItem<"color" | "depth" | "tracing" | "pick" | "emissive" | "marking">;
 ...
 */
export declare function createRenderItem<T extends string>(ctx: WebGLContext, drawMode: DrawMode, shaderCode: ShaderCode, schema: RenderableSchema, values: RenderableValues, materialId: number, renderVariants: T[], transparency: Transparency | undefined): RenderItem<T>;
export {};
