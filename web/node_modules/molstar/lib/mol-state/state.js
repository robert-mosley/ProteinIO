 ...
 */
import { StateObject, StateObjectSelector } from './object.js';
...
import { now, formatTimespan } from '../mol-util/now.js';
import { ParamDefinition } from '../mol-util/param-definition.js';
import { StateTreeSpine } from './tree/spine.js';
import { AsyncQueue } from '../mol-util/async-queue.js';
import { arraySetAdd, arraySetRemove } from '../mol-util/array.js';
import { UniqueArray } from '../mol-data/generic/unique-array.js';
import { assignIfUndefined } from '../mol-util/object.js';
export { State };
class State {
     ...
     */
    applyAction(action, params, ref = StateTransform.RootRef) {
