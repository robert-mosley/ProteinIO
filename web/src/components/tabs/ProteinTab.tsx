  ...
  if (!query) {
    return (
      <div className="flex flex-col items-center justify-center py-12 gap-3 text-center">
        ...
        <div className="text-sm text-slate-600">Search for a protein to view details</div>
      </div>
    )
  }
      ...
      <div className="rounded-xl border border-[#1a3355] bg-[#0d1829] p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 rounded-lg bg-[#0a1628] border border-[#1a3355] hover:border-[#2a4a6e] transition text-slate-500 hover:text-slate-300"
